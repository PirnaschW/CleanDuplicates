...
BOOL  CMainFrame::CreateDockingWindows()
{
	...
	ASSERT(bNameValid);
	if  (!m_wndScopeView.Create(strScopeView,  this,  CRect(0,  0,  200,  200),  TRUE,  ID_VIEW_CLASSVIEW,  WS_CHILD  |  WS_VISIBLE  |  WS_CLIPSIBLINGS  |  WS_CLIPCHILDREN  |  CBRS_LEFT  |  CBRS_FLOAT_MULTI))
	{
